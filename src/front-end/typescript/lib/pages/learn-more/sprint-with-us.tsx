            ...
            <Accordion
              ...
              open={state.isHowToApplyAccordionOpen}>
                ...
                <HowItWorksItem
                  ...
                  description={(
                    <div><Link dest={routeDest(adt('signIn', {}))}>Sign in</Link> to your Digital Marketplace Vendor account. If you do not yet have an account, you must <Link dest={routeDest(adt('signUpStepOne', {}))}>sign up</Link>, first.</div>)}
                  className='mb-4'
                />
                <HowItWorksItem
                  symbol_={adt('text', '2')}
